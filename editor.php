...
{  
	...
	case "set_node_properties":
		...
		// TARGET
		$map->nodes[$new_node_name]->target = $_REQUEST['node_target'];

		$targets = preg_split('/\s+/',$_REQUEST['node_target'],-1,PREG_SPLIT_NO_EMPTY);
		...
		$map->nodes[$new_node_name]->targets = $new_target_list;
	  ...
	  <div class="dlgBody">
		...
		<tr>
		  ...
		  <tr>
			...
			<td><input id="node_target" name="node_target" type="text" /></td>
		  </tr>
		  <tr>
			<th>Info URL</th>
